                ...
                <div className="grid justify-items-center grid-cols-1 md:grid-cols-3 p-5 gap-5">
                    {
                        loading ? (
                            ...
                            data.length > 0 ? (
                                        ...
                                        data.map((item) => (
                                            <>
                                                <div key={item.id} className="col-span-3 md:col-span-1">
                                                    <Item image={item.image} title={item.name} description={item.narration} detailLink={`/detail-hotel/${item.id}`} updateLink={`/update-hotel/${item.id}`} deleteItem={() => handleDelete(item.id)} />
                                                </div>
                                            </>
                                        ))
                                    }
                                ...
                                <div className="col-span-3">
                                    <NoData title="Sorry!" desc="No Data Available" link="/add-hotel" />
                                </div>
                            )
                        )
                    }
